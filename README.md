...
- Regulatory Source Graph for official-source audit-prep triggers across US SEC/CFTC, US SEC Regulation D accredited-investor review, US OFAC virtual-currency sanctions guidance, US FinCEN CVC/MSB and BSA transfer-recordkeeping review, US SEC DAO Report, US FTC advertising/endorsement guides, EU MiCA Title II, Article 75 CASP custody, and marketing communications, EU DORA ICT operational resilience, EU TFR crypto-asset transfer information review, EU AI Act, UK FCA financial promotions, UK FCA cryptoasset AML/MLR registration and Travel Rule guidance, UK Law Commission DAO scoping, UK ICO AI data protection guidance, Singapore MAS PSN02 and PS-G03 DPT customer-asset safeguards, Hong Kong SFC VATP custody, Japan FSA crypto-asset custody/user-protection guidance, Canada CSA CTP PRU custody/investor-protection guidance, Australia ASIC digital-asset financial-services and AUSTRAC VASP AML/CTF guidance, South Korea FSC Virtual Asset User Protection Act / Enforcement Decree and KoFIU VASP reporting / AML guidance, India FIU-IND / Ministry of Finance PMLA VDA AML/CFT guidance, Swiss FINMA ICO and stablecoin guidance, UAE VARA activity scope / compliance / 2024 marketing regulations, Brazil Banco Central, and Brazil CVM references, including effective dates, source review dates, and reviewer notes.
...
- Jurisdiction Packs with policy controls, evidence-ready status, and local-counsel routing for US, EU, UK, Singapore, Hong Kong, Japan, Canada, Australia, South Korea, India, Switzerland, UAE, Brazil, and fallback jurisdictions.
