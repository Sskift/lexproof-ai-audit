...
Evidence Vault sync carries linked regulatory control IDs from ledger source references into server records and the manifest hash while keeping raw evidence bytes out of API responses. Not legal advice.
