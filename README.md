...
The AI legal workflow scenario now routes `LexAssist Evidence Desk` into ABA Formal Opinion 512, US NIST AI RMF / NIST AI 600-1 Generative AI Profile, California CCPA ADMT consumer-rights review, Colorado SB26-189 ADMT consequential-decision review, EU AI Act, and UK ICO AI data protection source controls, with evidence gaps for legal-AI competence, confidentiality, client-communication, supervisory review, candor, fee treatment, govern/map/measure/manage evidence, GenAI output provenance, California CCPA ADMT scope, risk assessment, access, opt-out, secure response, Colorado ADMT scope, developer documentation, notice, adverse-outcome explanation, meaningful human review, record retention, human oversight, source lineage, redaction, and reviewer decision logs. Not legal advice.
