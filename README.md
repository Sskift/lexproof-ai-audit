...
Hong Kong tokenised product projects now route to SFC tokenisation and secondary-trading circular source controls, with evidence gaps for SFC-authorised product scope, prior consultation or approval route, ownership recordkeeping, operational soundness, cybersecurity/data-privacy/business-continuity controls, smart-contract integrity, price-deviation alert, indicative NAV, market-maker and liquidity arrangements, trading suspension workflow, investor risk disclosure, notification, and local-counsel handoff. The Jurisdiction Checklist also shows an SFC tokenised product authorisation and secondary-trading control that becomes evidence-ready only from metadata-only records carrying `control-hk-sfc-tokenised-investment-products-secondary-trading`, without raw investor records, wallet secrets, personal data, or legal conclusions. Not legal advice.
