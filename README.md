...
7. Counsel Pack template selection, Source Review Ledger preview, version save, server export record creation, Markdown export, Manifest JSON, and simulated anchor receipt.
