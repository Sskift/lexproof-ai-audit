...
The US custody and wallet authority control now becomes evidence-ready only from metadata-only NYDFS custody records carrying `control-us-nydfs-bitlicense-custody-customer-protection` plus matching custody, wallet, segregation, ledger, reconciliation, or sub-custody evidence text, without raw KYC, wallet secrets, customer records, personal data, or legal conclusions. Not legal advice.
