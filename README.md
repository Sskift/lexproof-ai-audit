...
Demo API preflight now requires non-empty, non-blank next actions on Human Review recovery, Model Gateway run recovery, Evidence Vault lineage digest, Counsel Pack export recovery, Audit Log export, and Integration Policy receipt bundle artifacts before the judge path can report ready. Not legal advice.
