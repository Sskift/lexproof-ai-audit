...
- Jurisdiction Packs with policy controls, evidence-ready status, and local-counsel routing for US, EU, UK, Singapore, Hong Kong, Japan, Canada, Switzerland, UAE, Brazil, and fallback jurisdictions.
...
1. Demo Scenario Library launch from a synthetic profile such as **High-risk RWA launch**, **DAO proposal review**, **Brazil VASP source review**, **Hong Kong VATP custody review**, **Japan crypto custody review**, **Canada CTP custody review**, or **Marketing claims review**.
