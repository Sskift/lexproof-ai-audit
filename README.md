...
The AI legal workflow scenario now routes `LexAssist Evidence Desk` into ABA Formal Opinion 512, US NIST AI RMF / NIST AI 600-1 Generative AI Profile, NYC Local Law 144 AEDT hiring/promotion review, California CCPA ADMT consumer-rights review, Colorado SB26-189 ADMT consequential-decision review, EU AI Act AI-literacy, Article 50 transparency, administration-of-justice/ADR perimeter review, and UK ICO AI data protection source controls, with evidence gaps for legal-AI competence, confidentiality, client-communication, supervisory review, candor, fee treatment, govern/map/measure/manage evidence, GenAI output provenance, NYC AEDT scope, independent bias audit, public summary, 10-business-day notice, accommodation or alternative-process routing, data/source/retention request handling, California CCPA ADMT scope, risk assessment, access, opt-out, secure response, Colorado ADMT scope, developer documentation, notice, adverse-outcome explanation, meaningful human review, record retention, AI use policy, source lineage, Article 50 user-interaction disclosure, AI-generated output labelling, editorial control, justice/ADR perimeter, high-risk oversight, fundamental-rights review, redaction, and reviewer decision logs. Not legal advice.
