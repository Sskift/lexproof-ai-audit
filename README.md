...
- Regulatory Source Graph for official-source audit-prep triggers across US SEC/CFTC, US FTC advertising/endorsement guides, EU MiCA Title II and Article 75 CASP custody, EU AI Act, UK FCA, UK ICO AI data protection guidance, Singapore MAS PSN02 and PS-G03 DPT customer-asset safeguards, Swiss FINMA, UAE VARA, Brazil Banco Central, and Brazil CVM references, including effective dates, source review dates, and reviewer notes.
...
- Counsel Pack Markdown download and browser Print / Save PDF handoff with non-advice disclaimer, project facts, risk posture, regulatory source graph, Source Review Ledger freshness metadata, Source Update Approval Queue gates, editable counsel questions, counsel review statuses, manifest hash, source pack, and remediation queue.
...
The RWA custody path now routes EU projects with platform wallet custody into MiCA Article 75 custody and administration review triggers, adding CASP custody policy and client crypto-asset safeguarding evidence gaps without making legal conclusions. Not legal advice.
...
The marketing claims scenario routes `SignalBridge Marketing Review` into US FTC endorsement/advertising, UK FCA financial-promotion, and UAE VARA marketing/access source controls, then opens the Marketing Claims Counsel Pack template with promotion approval gaps still visible. Not legal advice.
