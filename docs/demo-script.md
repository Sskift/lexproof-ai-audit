...
7. **Export counsel pack**
   ...
   - Show **Counsel Handoff Checklist** with checklist hash, handoff allowed/blocked state, Evidence Manifest, Evidence Recertification Queue, Regulatory Source Pack, Counsel Review Status, Counsel Pack Version, server export record, and Submission Pack readiness. Click **Download Handoff Checklist JSON** to show the metadata-only final handoff checklist. Not legal advice.
