...
0. **Start from a seeded scenario**
   ...
   - Optional alternate judge path: click **Start AI legal workflow review** to load `LexAssist Evidence Desk` and start in Model Intake for model governance, human review, ABA Formal Opinion 512 professional-responsibility review, US NIST AI RMF / NIST AI 600-1 Generative AI Profile, EU AI Act, UK ICO AI data protection source controls, and counsel export.
