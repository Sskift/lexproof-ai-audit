...
3. **Select or upload evidence**
   ...
   - Change one synthetic evidence item to `under-review`, then `rejected`, to show the local ledger preserves review-stage workflow states and keeps rejected records ready for replacement recovery rather than treating rejection as legal approval or deletion. Not legal advice.
