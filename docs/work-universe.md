...
- AI legal workflow source-control coverage is implemented for EU AI Act Article 4 / Chapter III review routing, EU AI Act Article 6(2) / Annex III point 8(a) administration-of-justice and ADR perimeter routing, and UK ICO AI data protection guidance. The `ai-compliance-workflow` evidence template carries `control-eu-ai-act-ai-literacy-governance`, `control-eu-ai-act-administration-justice-adr-perimeter`, and `control-uk-ico-ai-data-protection-governance` source references so the AI scenario can show human oversight, source lineage, justice/ADR perimeter, high-risk oversight, fundamental-rights review, redaction, and reviewer decision-log gaps without legal conclusions.
