...
- Thailand and Indonesia jurisdiction packs now route those source-backed controls into policy controls, evidence-ready status, and local-counsel handoff roles when a custom project includes `Thailand`, `Indonesia`, or the `ID` jurisdiction alias. Not legal advice.
