...
- Jurisdiction checklist and jurisdiction packs for initial US/EU/UK/Singapore/Hong Kong/Japan/Switzerland/UAE/Brazil routing.
...
2. **Deepen jurisdiction evidence next:** Expand source/control coverage for RWA, DAO governance, custody, AI legal workflow, marketing claims, and Brazil/Singapore/Hong Kong/Japan/UAE/UK/EU/US routes when each addition has reviewed source metadata and tests.
