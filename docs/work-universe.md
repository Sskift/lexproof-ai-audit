...
- Risk Audit source citation controls that attach Regulatory Source Graph citations, source URLs, local-counsel routes, coverage status, and top open source-linked evidence requests to each active deterministic risk flag without making legal conclusions.
