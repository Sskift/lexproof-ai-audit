...
function isDemoHumanReviewRecoveryPacketPayload(payload) {
  const summary = isRecord(payload) ? payload.summary : undefined;

  return (
    isRecord(payload) &&
    payload.packetVersion === "lexproof-server-human-review-recovery-packet-v1" &&
