  ...
  it("serves a metadata-only API preflight artifact for demo readiness", async () => {
    ...
    expect(payload.routeFamilies).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({ id: "human-review-recovery", path: "/api/workspaces/:workspaceId/reviews/recovery" }),
        ...
        expect.objectContaining({ id: "audit-log-recovery", path: "/api/workspaces/:workspaceId/audit-log/recovery" }),
    ...
    expect(payload.routeFamilyCount).toBe(21);
