...
export const demoScenarios: DemoScenario[] = [
  ...
  },
  {
    ...
    summary:
      "Model-connect governance, AI event intake, ABA Formal Opinion 512 professional-responsibility review, US NIST AI RMF / GenAI Profile, NYC AEDT hiring/promotion bias-audit review, California CCPA ADMT consumer-rights review, Colorado ADMT consequential-decision review, EU AI Act, UK ICO source review, human review, and counsel export.",
    estimatedMinutes: 6,
    ...
    judgePath: [
      ...
      "Register AI event",
      "Route human review",
      "Inspect ABA Formal Opinion 512 / US NIST / NYC AEDT / California CCPA ADMT / Colorado ADMT / EU AI Act / UK ICO source review",
      "Export counsel pack"
    ],
