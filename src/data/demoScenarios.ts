...
export const demoScenarios: DemoScenario[] = [
  {
    ...
    summary:
      "Tokenized private credit, custody, US FinCEN/BSA CVC transfer controls, EU DORA operational resilience, retail exposure, AI review, and manifest handoff.",
    estimatedMinutes: 8,
    ...
    focusTags: ["RWA", "US FinCEN/BSA", "EU DORA", "AI governance", "Evidence vault"],
