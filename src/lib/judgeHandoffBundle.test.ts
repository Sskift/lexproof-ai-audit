...
function submissionPack(overrides: Partial<SubmissionPack> = {}): SubmissionPack {
  return {
    ...
    regulatorySourceCoverageHash: "3".repeat(64),
    regulatorySourceCoverageStatus: "needs-evidence",
    demoRunbookHash: "b".repeat(64),
    sourceCount: 8,
    evidenceGapCount: 2,
    sourceCoverageJurisdictionCount: 2,
    sourceCoverageOpenEvidenceRequestCount: 2,
