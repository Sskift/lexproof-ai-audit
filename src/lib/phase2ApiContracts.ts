...
export function listPhase2ApiRoutes(): Phase2ApiRoute[] {
  return [
    ...
    createRoute(
      ...
      "/api/model-gateway/provider-policy",
      "model-gateway",
      "ModelGatewayProviderPolicyReceiptRequest",
      "ModelGatewayProviderPolicyReport",
      true
    ),
    createRoute(
    ...
    createRoute(
      "POST",
      "/api/integrations/grc-destination/policy",
      "integrations",
      "GrcDestinationPolicyRequest",
    ...
    createRoute(
      "GET",
      "/api/workspaces/:workspaceId/reviews/recovery",
      "human-review",
      "ServerHumanReviewRecoveryRequest",
