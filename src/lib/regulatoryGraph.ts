...
function jurisdictionAliases(jurisdiction: string): string[] {
  ...
  const aliases: Record<string, string[]> = {
    ...
    indonesia: ["indonesia", "indonesian", "id", "ri"],
    ...
    philippine: ["philippines", "philippine", "ph"],
    ph: ["philippines", "philippine", "ph"],
    "south africa": ["south africa", "za", "rsa", "south african"],
    "south african": ["south africa", "za", "rsa", "south african"],
    za: ["south africa", "za", "rsa", "south african"],
    rsa: ["south africa", "za", "rsa", "south african"],
